...
Glossary:
${report.glossary.map(g => `${g.term}: ${g.definition}`).join('\n')}
    `.trim();
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="mt-8 p-4 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
            ...
            <p className="text-xs text-amber-800 leading-relaxed">
               <strong>Disclaimer:</strong> {report.disclaimer} This tool uses AI and may make mistakes. It is for informational purposes only and does not constitute medical advice, diagnosis, or treatment. Always consult your doctor.
            </p>
          </div>
        </div>
